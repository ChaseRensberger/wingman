    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Border
          'border border-border data-hover:border-foreground/20 dark:border-border dark:data-hover:border-foreground/20',
          // Background color
          ...
          // Disabled state
          'data-disabled:border-border/50 dark:data-disabled:border-border/50 dark:data-disabled:bg-white/2.5 dark:data-hover:data-disabled:border-border/50',
          // System icons
          'dark:scheme-dark',
        ])}
      />
