...
//   - Get(provider, model) returns a normalized wingmodels.ModelInfo for use
...
// Get returns a normalized wingmodels.ModelInfo for a provider/model pair.
...
func Get(providerName, modelID string) (wingmodels.ModelInfo, bool) {
