...
func buildReq(t *testing.T, req wingmodels.Request) responsesRequest {
	t.Helper()
	c := &Client{model: "gpt-test", maxTokens: defaultMaxTokens, baseURL: defaultBaseURL}
	caps := wingmodels.ModelCapabilities{}
	return c.buildRequest(req, caps)
}

func buildReqWithCaps(t *testing.T, req wingmodels.Request, caps wingmodels.ModelCapabilities) responsesRequest {
	t.Helper()
...
func TestBuildRequest_Reasoning_WithEffort(t *testing.T) {
	caps := wingmodels.ModelCapabilities{Reasoning: true}
	req := wingmodels.Request{
		Messages: []wingmodels.Message{wingmodels.NewUserText("think")},
		Capabilities: wingmodels.Capabilities{
			Thinking: &wingmodels.ThinkingConfig{Effort: "high"},
		},
	}
...
func TestBuildRequest_Reasoning_NonReasoningModel(t *testing.T) {
	...
	caps := wingmodels.ModelCapabilities{Reasoning: false}
	req := wingmodels.Request{
		Messages:     []wingmodels.Message{wingmodels.NewUserText("hi")},
...
func TestBuildRequest_Store_AlwaysFalse(t *testing.T) {
	req := wingmodels.Request{Messages: []wingmodels.Message{wingmodels.NewUserText("hi")}}
	r := buildReq(t, req)
