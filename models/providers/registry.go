...
// "anthropic", "ollama") to a factory that constructs a models.Model.
//
...
// ProviderFactory builds a models.Model from an opaque options bag.
// Returning a nil Model with a nil error is a contract violation; New rejects
// it.
type ProviderFactory func(opts map[string]any) (models.Model, error)
...
func (r *Registry) New(providerID string, opts map[string]any) (models.Model, error) {
...
func New(providerID string, opts map[string]any) (models.Model, error) {
