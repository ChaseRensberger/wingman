...
func buildWireReq(t *testing.T, req models.Request) (request, builtRequest) {
	t.Helper()
...
func TestBuildRequest_ToolChoice_Auto(t *testing.T) {
	req := models.Request{
		...
		Tools:    []models.ToolDef{{Name: "bash", Description: "run bash", InputSchema: map[string]any{"type": "object"}}},
...
func TestBuildRequest_Thinking_BudgetBased(t *testing.T) {
	...
	req := models.Request{
		...
		Capabilities: models.Capabilities{
			Thinking: &models.ThinkingConfig{BudgetTokens: 2048},
		},
	}
	built := c.buildRequest(req)
...
func TestBuildRequest_ToolChoice_JSON(t *testing.T) {
	req := models.Request{
		Messages:   []models.Message{models.NewUserText("hi")},
		Tools:      []models.ToolDef{{Name: "edit", Description: "edit file", InputSchema: map[string]any{"type": "object"}}},
		ToolChoice: models.ToolChoice{Mode: models.ToolChoiceRequired},
	}
	wire, _ := buildWireReq(t, req)
	wire.Stream = false
