...
function ClientsPage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-4 px-4 py-6">
    <PageBreadcrumb items={[{ label: "Clients" }]} />
    <Card size="sm"><CardHeader><CardTitle>Clients</CardTitle></CardHeader><CardContent className="space-y-4">
