...
export default function ProvidersPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      <div className="mb-4">
        <h1 className="text-base font-semibold">Providers</h1>
        <p className="text-sm text-muted-foreground">Configure provider auth and inspect available model capabilities.</p>
      </div>
