...
func syncDemo(ctx context.Context, model models.Model) {
	req := models.Request{
		System: "You are a terse assistant.",
		Messages: []models.Message{
			models.NewUserText("What is Go?"),
		},
	}

	msg, err := models.Run(ctx, model, req)
	if err != nil {
...
func streamDemo(ctx context.Context, model models.Model) {
	req := models.Request{
		System: "You are a terse assistant.",
		Messages: []models.Message{
			models.NewUserText("Count from 1 to 5 slowly."),
		},
	}
...
func toolsDemo(ctx context.Context, model models.Model) {
	req := models.Request{
		System: "You have access to a calculator. Use it for math.",
		Messages: []models.Message{
			models.NewUserText("What is 123 * 456?"),
		},
...
func structuredDemo(ctx context.Context, model models.Model) {
	...
	req := models.Request{
		...
		Messages: []models.Message{
			models.NewUserText("Tell me about Saturn."),
		},
		OutputSchema: schema,
	}
