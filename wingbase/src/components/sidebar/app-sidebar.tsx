...
export function AppSidebar() {
  ...
  return (
    <div className="flex grow flex-col items-center overflow-y-auto border-r border-border bg-card pb-4">
        ...
        <ul role="list" className="flex flex-1 flex-col items-center gap-y-1">
          ...
          <li className="mt-auto">
            <button
              ...
              title="Settings"
              className="group flex size-10 cursor-pointer items-center justify-center rounded-md text-muted-foreground hover:bg-accent hover:text-foreground"
            >
