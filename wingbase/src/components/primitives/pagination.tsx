  ...
  return (
    <Button
      ...
      className={clsx(
        ...
        current && 'before:bg-foreground/5 dark:before:bg-background/10'
      )}
    >
...
export function PaginationGap({
  ...
  return (
    <span
      aria-hidden="true"
      {...props}
      className={clsx(className, 'w-9 text-center text-sm/6 font-semibold text-foreground select-none dark:text-foreground')}
    >
      {children}
    </span>
  )
