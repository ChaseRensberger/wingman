...
const STORAGE_KEY = "ui-theme-overrides"
...
export function clearAllOverrides(overrides: OverrideMap) {
	...
	window.dispatchEvent(new CustomEvent("ui-overrides-cleared"))
}
...
export function ThemeCustomizer() {
	...
	React.useEffect(() => {
		...
		window.addEventListener("ui-overrides-cleared", handleCleared)
		return () => window.removeEventListener("ui-overrides-cleared", handleCleared)
	}, [])
