// Package loop is the wingharness inference loop. It drives a wingmodels.Model
...
//
//   - Persistence. The caller (typically wingharness/session) hooks into
...
// usage tracking; the wingharness/hook package ships a default compaction
